...
export const withChartTheme = (
...
): ChartjsComponentType => ({ options, data }) => (
  <ThemeContext.Consumer>
    {theme => {
      ...
      themedOptions.scales.xAxes = themedOptions.scales.xAxes.map(x =>
        deepMerge(axisColors, x),
      );
      themedOptions.scales.yAxes = themedOptions.scales.yAxes.map(y =>
        deepMerge(axisColors, y),
      );
      let datasets;
