...
import { withChartThemeProps, ChartjsComponentType } from './withChartThemeProps';
...
export const withChartTheme = (
  WrappedComponent,
  { classOpacity = 0.6, defaultScales = [{}], ...other }: withChartThemeProps = {}
