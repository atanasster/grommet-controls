...
export interface IDropInputOwnProps {
  ...
  onChange?: ((x: { target: React.RefObject<HTMLInputElement>['current'] }) => void),
...
export type IDropInputProps = IDropInputOwnProps & TextInputProps &
    Omit<JSX.IntrinsicElements['input'], 'defaultValue' | 'onSelect' | 'size' | 'placeholder' | 'onChange' | 'ref'>;
