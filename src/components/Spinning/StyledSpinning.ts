...
export const ThreeBounceSpinner = styled.div<ISpinningProps>`
...
export const DoubleBounceSpinner = styled.div<ISpinningProps>`
  width: ${props => props.theme.global.edgeSize[props.size]};
  height: ${props => props.theme.global.edgeSize[props.size]};
  position: relative;
...
export const WanderingCubesSpinner = styled.div<ISpinningProps>`
  width: 52px;
  height: 52px;
  position: relative;
...
export const RotatingPlaneSpinner = styled.div<ISpinningProps>`
  width: ${props => props.theme.global.edgeSize[props.size]};
  height: ${props => props.theme.global.edgeSize[props.size]};
  background-color: ${props => normalizeColor(props.color, props.theme)};
...
export const PulseSpinner = styled.div<ISpinningProps>`
  width: ${props => props.theme.global.edgeSize[props.size]};
  height: ${props => props.theme.global.edgeSize[props.size]};
  background-color: ${props => normalizeColor(props.color, props.theme)};
  border-radius: 100%;
