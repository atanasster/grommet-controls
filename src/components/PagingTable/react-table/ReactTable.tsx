...
> {
  ...
  static getDataModel = (newState, props) => {
    const {
      columns,
      pivotBy = [],
      data,
    ...
    const addHeader = (columns: any[], column?: IPagingTableColumn): void => {
      headerGroups.push({
        ...props.column,
        ...column,
        columns,
    ...
    if (filtered.length) {
      ...
      filteredData = filteredData
        .map((row) => {
          ...
          return {
            ...row,
            [props.subRowsKey]: ReactTable.filterData(
              row[props.subRowsKey],
              filtered,
              defaultFilterMethod,
              allVisibleColumns,
              props,
  ...
  static sortData = (
    ...
    sortedData.forEach((row) => {
      ...
      row[props.subRowsKey] = ReactTable.sortData(
        row[props.subRowsKey],
        sorted,
        sortMethodsByColumnID,
        props,
  ...
  filterColumn = (column: IPagingTableColumn, value: any) => {
